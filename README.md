...
- [0.1.5 Beta 发布说明](docs/release-notes-0.1.5-beta.md)
...
- 构建产物：`neoforge-26.2/build/libs/earth-on-minecraft-neoforge-26.2-0.1.5.jar`
- 测试部署：`D:\_dx\_Games\MC\xxxxxx\.minecraft\versions\26.2-NeoForge_26.2.0.7-beta\mods`
- 发布状态：`0.1.5` 是开发中测试版，用于验证现实矿床、围岩/伴生特征、工业机器、电力、手册、JEI 联动和可复现打包流程。
